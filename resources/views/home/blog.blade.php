<section class="blog py-5">
    <div class="container">
        <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
            ...
            <a href="{{ url('/')}}" class="btn-link">View All</a>
        </div>
        <div class="row">
            <div class="col-md-4">
                <article class="post-item">
                    <div class="post-image">
                        <a href="{{ url('/')}}">
                            <img src="{{ url('assets/images/post-image1.jpg') }}" alt="image"
                    ...
                    <div class="post-content d-flex flex-wrap gap-2 my-3">
                        ...
                        <h5 class="post-title text-uppercase">
                            <a href="{{ url('/')}}">How to look outstanding in pastel</a>
                        </h5>
            ...
            <div class="col-md-4">
                <article class="post-item">
                    <div class="post-image">
                        <a href="{{ url('/')}}">
                            <img src="{{ url('assets/images/post-image2.jpg') }}" alt="image"
                                class="post-grid-image img-fluid">
                        </a>
                    </div>
                    <div class="post-content d-flex flex-wrap gap-2 my-3">
                        ...
                        <h5 class="post-title text-uppercase">
                            <a href="{{ url('/')}}">Top 10 fashion trend for summer</a>
                        </h5>
            ...
            <div class="col-md-4">
                <article class="post-item">
                    <div class="post-image">
                        <a href="{{ url('/')}}">
                            <img src="assets/images/post-image3.jpg" alt="image"
                                class="post-grid-image img-fluid">
                        </a>
                    </div>
                    <div class="post-content d-flex flex-wrap gap-2 my-3">
                        ...
                        <h5 class="post-title text-uppercase">
                            <a href="{{ url('/')}}">Crazy fashion with unique moment</a>
                        </h5>
                        <p>Turpis purus, gravida orci, fringilla dignissim lacus, turpis ut suspendisse vel
                            tellus...</p>
                    </div>
