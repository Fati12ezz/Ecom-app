                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-4 pe-3">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownHome">
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Home Layout 1</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Home Layout 2 </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Home Layout 3 </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Home Layout 4 </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Shop Sidebar </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Shop Three Column
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Shop Three Column
                                    ...
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Shop Four Column
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Shop Four Column
                                    ...
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Shop Six Column
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Shop Six Column
                                    ...
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Single Product </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Single Product V2
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownBlog">
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Blog Classic </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Blog Grid with
                                            Sidebar </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Blog Grid Four
                                            Column </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Blog No Sidebar
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Blog Right Sidebar
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Single Post </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Single Post No
                                            Sidebar </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownPages">
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">About </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Cart </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Checkout </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Coming Soon </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Contact </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Error Page </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">FAQs </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">My Account </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Order Tracking </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/')}}" class="dropdown-item item-anchor">Wishlist </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item d-none d-lg-block">
                                <a class="nav-link" href="{{ url('/')}}" class="text-uppercase mx-3">Wishlist <span
                                        class="wishlist-count">(0)</span>
                                </a>
                            </li>
                            <li class="nav-item d-none d-lg-block">
                                <a class="nav-link" href="{{ url('/')}}" class="text-uppercase mx-3" data-bs-toggle="offcanvas"
                                    data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">Cart <span
                                        class="cart-count">(0)</span>
                                </a>
                            </li>
                            <li class="nav-item d-lg-none">
                                <a class="nav-link" href="#" class="mx-2">
                            ...
                            <li class="nav-item d-lg-none">
                                <a class="nav-link" href="#" class="mx-2" data-bs-toggle="offcanvas"
                            ...
                            <li class="nav-item search-box text-center" class="">
                                <a class="nav-link" href="#search" class="search-button">
                                    <svg width="24" height="24" viewBox="0 0 24 24">
                                        <use xlink:href="#search"></use>
                                    </svg>
                                </a>
